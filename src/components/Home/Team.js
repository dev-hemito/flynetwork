...
const TeamBoard = () => {
  ...
  const boardMembers = [
    ...
    { name: 'Mr. Suresh Kumar K', role: 'Founder - Skybertech', image: '/members/Image.jpg' },
    { name: 'Mr. Madhu Bhaskaran', role: 'Director Samagra', image: '/members/Image.jpg' },
    { name: 'Mr. Shihabudheen', role: 'AI Consultant', image: '/members/Image.jpg' },
  ];
